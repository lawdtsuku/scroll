import {ROSTER_OPERATIONS,operationError} from './roster.js';
...
export function validateUpdate(u){
 ...
 for(const [operationIndex,o] of u.operations.entries()){try{assertImportable([o]);if(o.effective_day!==undefined)integer(o.effective_day,'effective_day',0);
 ...
 }catch(err){throw operationError(err,operationIndex,o);}
 }
 return clone(u);
}
