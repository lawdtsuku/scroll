const CACHE='scroll-consolidated-v9';
const ASSETS=['./','./index.html','./style.css','./app.js','./boot.js','./core.js','./db.js','./updates.js','./progress.js','./operation-policy.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png','./scroll-dm-template-kit.zip'];
